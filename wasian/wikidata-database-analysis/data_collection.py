...
chinese_graph.set_title(
    "Most Linked Academic Databases in Chinese Academic Articles on Wikidata"
)
...
spanish_graph.set_title(
    "Most Linked Academic Databases in Spanish Academic Articles on Wikidata"
)
...
portuguese_graph.set_title(
    "Most Linked Academic Databases in Portuguese Academic Articles on Wikidata"
)
...
russian_graph.set_title(
    "Most Linked Academic Databases in Russian Academic Articles on Wikidata"
)
...
japanese_graph.set_title(
    "Most Linked Academic Databases in Japanese Academic Articles on Wikidata"
)
...
french_graph.set_title(
    "Most Linked Academic Databases in French Academic Articles on Wikidata"
)
...
korean_graph.set_title(
    "Most Linked Academic Databases in Korean Academic Articles on Wikidata"
)
...
german_graph.set_title(
    "Most Linked Academic Databases in German Academic Articles on Wikidata"
)
...
italian_graph.set_title(
    "Most Linked Academic Databases in Italian Academic Articles on Wikidata"
)
...
dutch_graph.set_title(
    "Most Linked Academic Databases in Dutch Academic Articles on Wikidata"
)
